  ...
  function firebaseAction (action) {
    return function firebaseEnhancedActionFn (context, payload) {
      ...
      var ops = {
        ...
        add: function (target, newIndex, data) { return commit(VUEXFIRE_ARRAY_ADD, { target: target, newIndex: newIndex, data: data }, commitOptions); },
      ...
      context.bindFirebaseRef = function (key, ref, options) {
          ...
          return bind({ state: state, commit: commit, key: key, ref: ref, ops: ops }, options);
      };
